            ...
            <div class="col-lg-7 mx-auto text-white">
              ...
              <div class=" d-flex row mt-5">
                <div class="col-6 text-center mt-xl-2">
                  <a class="text-white font-weight-medium"  href="#" onclick="history.back(); return false;">Kembali Ke halaman Sebelumnya</a>
                </div>
                <div class="col-6 text-center mt-xl-2">
                  <a class="text-white font-weight-medium" href="/logout">Kembali Ke halaman Login</a>
                </div>
              </div>
              <div class="row mt-5">
